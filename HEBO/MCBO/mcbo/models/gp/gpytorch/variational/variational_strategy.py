...
from ..variational._variational_strategy import _VariationalStrategy
from ..variational.cholesky_variational_distribution import CholeskyVariationalDistribution
